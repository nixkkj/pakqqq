...
:: Disabling AppInfo. (Added as the base Oneclick no longer disables it)
sc config AppInfo start=disabled >nul 2>&1

:: Services.
echo ✔  Disabling AppXSvc.
